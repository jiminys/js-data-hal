describe('DSHalAdapter.create(resourceConfig, attrs, options)', function () {

  it('should make a POST request', function (done) {
    var _this = this;

    adapter.create(Post, { author: 'John', age: 30 }).then(function (data) {
      assert.deepEqual(data, p1, 'post should have been created');

      adapter.create(Post, { author: 'John', age: 30 }, { basePath: 'api2' }).then(function (data) {
        assert.deepEqual(data, p1, 'post should have been created');
